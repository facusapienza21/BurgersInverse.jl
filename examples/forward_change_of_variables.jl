"""
This solves the Burgers equation by using instead the change of variables τ = -log(t)
"""
...
"""
Out-place Burgers inverse update
"""
...
# We need to reevaluate f in the new values. 
# f = first.(sol.(t, Val{1}))
...
# Lets check the residuals are small 
res = finite_differences(u, t, 1) #.- f

# This seems to be working!!! 
# Notice that I don't have to evan evaluare the second term, I am doing it with the discrete third derivative
∂³res = finite_differences(u, t, d+1) #.- finite_differences(f, t, d)
...
λ_scan = LinRange(0.245, 0.255, 1000)
...
for _λ in λ_scan
    ...
    _∂³res = finite_differences(_u, _t, d+1)
